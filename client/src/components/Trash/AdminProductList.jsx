...
console.log("AdminProductList component is rendering. Current products state:", products); // ADD THIS LINE
...
const fetchProducts = async () => {
    console.log("fetchProducts function is being called in AdminProductList!"); 
    setLoading(true);
    setError(null);
    try {
        ...
        if (searchQuery) {
            ...
            console.log("Lowercase search query:", lowerSearchQuery); 
            console.log("Products before filtering:", fetchedProducts); 
            ...
            console.log("Products after filtering:", fetchedProducts); // Log products after filtering

        }
         // --- End Client-Side Search Filtering ---
        console.log("Value of fetchedProducts just before setProducts:", fetchedProducts);
        setProducts(fetchedProducts); // Set the filtered (or unfiltered) products
        console.log("Products state after setting in AdminProductList:", products);
        setLoading(false);
        console.log("Fetched admin products:", response.data);
    } catch (err) {
...
const handleAddProductSubmit = async (e) => {
    ...
    try {
        ...
        await axios.post('/api/admin/products', productData); //  Using /api/products endpoint for adding product (same as ProductsPage)
...
return (
    <div className="admin-product-list"> {/* Container for Admin Product List Page */}
        ...
        <div className="products-filter-bar"> {/* Container for filters and search */}
        ...
        {loading ? (
            ...
            // --- Product Table (Copied from ProductsPage.jsx) ---
